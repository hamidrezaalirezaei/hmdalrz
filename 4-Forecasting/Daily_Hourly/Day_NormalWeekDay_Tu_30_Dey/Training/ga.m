...
CostFunction=@Training_D670;     % Cost Function

nVar=3;             % Number of Decision Variables

VarSize=[1 nVar];   % Decision Variables Matrix Size

VarMin= 1e-5;            % Lower Bound of Decision Variables
VarMax= 1.0e+06;            % Upper Bound of Decision Variables
